// ─── COLLECTION PAGE (dedicated category route) ─────────
...
function getRefs() {
    ...
    heading = document.getElementById('collectionHeading');
...
function render(resetScroll = true) {
    ...
    if (total === 0) {
        ...
        if (noMsg) {
            ...
            noMsg.textContent = 'No products found in this collection.';
        }
...
async function init() {
    ...
    currentCategory = (params.get('category') || 'all').toLowerCase();
